    ...
    class Meta:
        ...
        widgets = {
            "label": forms.TextInput(
                attrs={"class": "form-label", "placeholder": "Libellé de la compétence"}
            ),
            "level": forms.NumberInput(
                attrs={"class": "form-label", "placeholder": "Pourcentage de maîtrise"}
            ),
        }
    ...
    def clean_level(self):
        ...
        if level is None:
            raise forms.ValidationError(
                "Vous ne pouvez pas créer une compétence sans niveaux de compétence."
            )
